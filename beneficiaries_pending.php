...
$deletequery = "DELETE FROM beneficiaries WHERE status=0";
$query = $dbConn->getConnection()
->query($deletequery);
$successMessage = "Deleted";
$showAlert = 'successDelete';
...
$pendingsQuery = $dbConn->getConnection()
  ->query("SELECT * FROM beneficiaries WHERE status=0");
$beneficiariesPendingResult = $pendingsQuery->fetch_all(MYSQLI_ASSOC);


$beneficiariesQuery = $dbConn->getConnection()
  ->query("SELECT * FROM beneficiaries WHERE is_deleted = 0 AND status=0");
...
$allBeneficiaryResult = $beneficiariesPendingResult;
          ...
          <div class="row">
            <div class="col-md-3 col-sm-6 col-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">Pending Active</span>
            ...
            <div class="col-md-3 col-sm-6 col-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">Pending Inactive</span>
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Pending Beneficiaries</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
