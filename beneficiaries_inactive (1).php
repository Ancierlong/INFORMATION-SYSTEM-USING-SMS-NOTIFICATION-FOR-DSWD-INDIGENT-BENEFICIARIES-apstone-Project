...
$allBeneficiaryResult = $inactiveBeneficiariesQuery;
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Inactive Beneficiaries</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      foreach ($allBeneficiaryResult as $key => $beneficiary) {
                        ...
                        <td>{$propertyLib[$beneficiary['property']]}</td>
                        <td>{$familyList}</td>
                      </tr>
