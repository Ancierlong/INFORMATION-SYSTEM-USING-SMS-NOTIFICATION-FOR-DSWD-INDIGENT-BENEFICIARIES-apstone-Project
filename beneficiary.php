...
if (isset($_POST['update_beneficiary'])) {
  ...
  try {
    ...
    $actions = "Update beneficiaty / Save Family member";
                        ...
                        <div class="col-sm-6">
                          ...
                          <div class="form-group">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="status" value="0" checked="<?= $beneficiariesResult['0']['status'] == 0 ? 'checked' : ''; ?>">
                              <label class="form-check-label">Pending</label>
                            </div>
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="status" value="1" <?= $beneficiariesResult['0']['status'] == 1 ? 'checked' : ''; ?>>
                              <label class="form-check-label">Approved</label>
                            </div>
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="status" value="2" <?= $beneficiariesResult['0']['status'] == 2 ? 'checked' : ''; ?>>
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control input-lrif" placeholder="ex. 1001" maxlength="10" name="lrif_number" value="<?= $beneficiariesResult['0']['lrif_number']; ?>" required>
                          </div>
                        </div>
