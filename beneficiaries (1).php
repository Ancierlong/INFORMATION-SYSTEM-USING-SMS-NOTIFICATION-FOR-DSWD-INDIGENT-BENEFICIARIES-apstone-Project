...
$lrifIdsQuery = $dbConn->getConnection()
  ->query("SELECT lrif_number from beneficiaries");
            ...
            <form action="" method="POST" enctype="multipart/form-data">
              <div class="modal-body">
                ...
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control input-lrif" placeholder="ex. 1001" maxlength="10"
                        name="lrif_number" required id="lrif_number">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <div class="input-group date" id="indigent_start_date" data-target-input="nearest">
                        <input onkeydown="return false" type="text" class="form-control datetimepicker-input"
                          name="indigent_start_date" data-target="#indigent_start_date" required>
                ...
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control input-name" rows="3" placeholder="ex. Juan." name="first_name"
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input class="form-control input-name" rows="3" placeholder="ex. Gonzaga" name="middle_name"
                        maxlength="50">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control input-name" rows="3" placeholder="ex. Dela Cruz" name="last_name"
                        require maxlength="50">
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <div class="input-group date" id="birthday" data-target-input="nearest">
                        <input onkeydown="return false" type="text" class="form-control datetimepicker-input"
                          name="birthday" data-target="#birthday" required>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control input-numbers" id="" placeholder="ex. 09912345678"
                        name="mobile_number" maxlength="11" minlength="11" value="">
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="" placeholder="ex. 123 Quezon City" name="address"
                ...
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      <div class="form-check">
                        <input class="form-check-input employment_status" type="radio" name="employment" id="unemployed" checked="" value="2">
                        <label class="form-check-label">Unemployed</label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input employment_status" type="radio" name="employment"   id="employed" value="1">
                ...
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <div>
                      <label class="col-form-label" for=""><span style="color:red">* </span>Income and
                        Livelihood</label>
                      <div class="form-group">
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="income_and_livelihood" checked=""
                            value="1">
                  ...
                  <div class="col-sm-6">
                    ...
                    <div>
                      ...
                      <div class="form-group">
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="household_family_structure" checked="" value="1">
                          <label class="form-check-label">Single Parent Family
                          </label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="household_family_structure" value="2">
                          <label class="form-check-label">Single Household</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="household_family_structure" value="3">
                          <label class="form-check-label">Childless Family</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="household_family_structure" value="4">
                          <label class="form-check-label">Extended Family</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="household_family_structure" value="5">
      ...
      <section class="content">
        <div class="container-fluid">
          <div class="row my-2">
                ...
                <form method='POST'>
                  ...
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu" role="menu">
                      ...
                      <button name='delete_selected_rows' class='btn-delete dropdown-item' disabled>Delete
                        Selected</button>
            ...
            <?php } ?>
            <div class="col-md-3 col-sm-6 col-6">
              <a type="button" target="_blank" href="generate_report.php" name="generate_report_btn"
          ...
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span
                  class="info-box-number"><?php echo count($beneficiariesResult) + count($inactiveBeneficiariesResult) ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
                ...
                <table id="example1" class="table table-bordered table-striped">
                  <thead>
                    ...
                    <th>LRIF #</th>
                      ...
                      <th>Household Family Structure</th>
                  ...
                  <tbody>
                    ...
                    foreach ($allBeneficiaryResult as $key => $beneficiary) {
                      ...
                      $hasImage = $beneficiary['image_file_name'] != '' && is_null($beneficiary['image_file_name']) == false ? "<img src='upload_images/{$beneficiary['image_file_name']}' style='max-width: 50px;'>" : '-';
                      echo "
                        <tr>
                        <td>
                        " .
                        ...
                        <a href='beneficiary.php?id={$beneficiary['id']}'> <i class='fas fa-pen'></i></a>{$beneficiary['lrif_number']}</td>
                        <td>$hasImage</td>
                        ...
                        <td>{$householdFamilyStructure[$beneficiary['household_family_structure']]}</td>
                        <td>{$employmentStatus[$beneficiary['employment']]}</td>
