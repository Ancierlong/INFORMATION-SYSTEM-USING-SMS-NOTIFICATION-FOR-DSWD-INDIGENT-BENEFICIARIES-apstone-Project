...
$deletequery = "DELETE FROM beneficiaries WHERE status=2";
$query = $dbConn->getConnection()
->query($deletequery);
$successMessage = "Deleted";
$showAlert = 'successDelete';
...
$beneficiariesRejectedQuery = $dbConn->getConnection()
  ->query("SELECT beneficiaries.*, users.name as rejected_name FROM beneficiaries left join users on users.id = beneficiaries.rejected_by WHERE status=2");
$beneficiariesRejectedResult = $beneficiariesRejectedQuery->fetch_all(MYSQLI_ASSOC);


$beneficiariesQuery = $dbConn->getConnection()
  ->query("SELECT * FROM beneficiaries WHERE is_deleted = 0 AND status=2");
$beneficiariesResult = $beneficiariesQuery->fetch_all(MYSQLI_ASSOC);

$inactiveBeneficiariesQuery = $dbConn->getConnection()
  ->query("SELECT * FROM beneficiaries WHERE is_deleted = 1 AND status=2");
$inactiveBeneficiariesResult = $inactiveBeneficiariesQuery->fetch_all(MYSQLI_ASSOC);

$allBeneficiaryResult = $beneficiariesRejectedResult;
          ...
          <div class="modal-content">
            ...
            <form action="" method="POST">
              ...
              <div class="modal-footer justify-content-between">
                ...
                <button type="submit" class="btn btn-primary" name="add_beneficiary">Create</button>
              </div>
            </form>
          </div>
          <!-- /.modal-content -->
          ...
          <div class="row">
            <div class="col-md-3 col-sm-6 col-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">Rejected Active</span>
            ...
            <div class="col-md-3 col-sm-6 col-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">Rejected Inactive</span>
            ...
            <section class="col-lg-12 connectedSortable"> 
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Rejected Beneficiaries</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      foreach ($allBeneficiaryResult as $key => $beneficiary) {
                        ...
                        <td>$hasImage</td>
                        <td>{$beneficiary['reason_for_rejection']}</td>
                        <td>{$beneficiary['rejected_name']}</td>
