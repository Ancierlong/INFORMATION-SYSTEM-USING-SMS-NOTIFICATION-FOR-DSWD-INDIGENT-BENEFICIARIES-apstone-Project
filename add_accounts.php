...
'{$user_id}', '{$password}')");
  ...
  $showAlert = 'success';
  $alertMessage = "Account successfully created.<br> Email is sent to {$email}";

  $messageDetails['email'] = $recipientAddress = $email;
  $messageDetails['password'] = $passwordString;
  $systemMail->sendAccountTemporaryPassword($recipientAddress, $messageDetails);
...
$accountListQuery = $dbConn->getConnection()
  ->query("SELECT u1.name, u1.role, u1.birthday, u1.email, u1.gender, u1.approval_status, u1.created_at, u2.name as created_by FROM users u1 LEFT JOIN users u2 ON u1.created_by = u2.id");
...
<div class="form-check">
                              <input class="form-check-input" type="radio" name="role" checked="" value="1">
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        ...
                        <div class="form-group">
                          ...
                          <input class="form-control input-name" rows="3" placeholder="ex. Juan." name="name" maxlength="50" required value="<?= $name ?>">
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="email" class="form-control <?= $isEmailTakenResult ? 'is-invalid' : ''?>" rows="3" placeholder="ex. juan.dela.cruz@gmail.com" required name="email" maxlength="50" value="<?= $email ?>">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <div class="input-group date" id="birthday" data-target-input="nearest">
                            <input onkeydown="return false" type="text" class="form-control datetimepicker-input" name="birthday" data-target="#birthday" required value="<?= $birthday ?>">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          <div class="form-check">
                            <input class="form-check-input" type="radio" name="gender" checked="<?= is_null($gender) || $gender == 1 ? 'checked' : '' ?>" value="1">
                            <label class="form-check-label">Male</label>
                          </div>
                          <div class="form-check">
                            <input class="form-check-input" type="radio" name="gender" checked="<?= $gender == 2 ? 'checked' : '' ?>" value="2">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control input-numbers" id="" placeholder="ex. 09912345678" name="mobile_number" required maxlength="11" minlength="11" value="<?= $mobile_number ?>">
                        </div>
                      </div>
                    </div>
                  </div>
