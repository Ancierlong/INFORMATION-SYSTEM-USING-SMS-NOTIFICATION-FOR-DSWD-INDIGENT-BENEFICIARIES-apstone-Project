...
$allBeneficiaryQuery = $dbConn->getConnection()
  ...
  ->query("(SELECT gender, household_category, birthday,  1 as is_beneficiary, category_category, income_and_livelihood, water_and_sanitation, property  FROM beneficiaries WHERE is_deleted = 0 and status =1 )
  UNION ALL
  (SELECT bf.gender, null, bf.birthday, 0 as is_beneficiary, null, null, null, null  FROM beneficiaries  as b
      ...
      <section class="content-header">
        <div class="container-fluid">
          ...
          <div class="col-md-3 col-sm-6 col-6">
                <a type="button" target="_blank" href="generate_dashboard_report.php" name="generate_report_btn" class="btn btn-success"><i class="nav-icon  fas fa-download"></i> Generate Report</a>
            </div>
        </div><!-- /.container-fluid -->
      </section>
      <!-- /.content-header -->
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-warning">
                ...
                <a href="beneficiaries.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <div class="col-lg-3 col-6">
              <!-- small box -->
                ...
                <div class="col-md-6">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <canvas id="pieChartBeneficiariesGender" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 532px;" width="1064" height="500" class="chartjs-render-monitor"></canvas>
                    </div>
                    <!-- /.card-body -->
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <canvas id="pieChartBeneficiariesAge" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 532px;" width="1064" height="500" class="chartjs-render-monitor"></canvas>
                    </div>
                    <!-- /.card-body -->
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <canvas id="pieChartBeneficiariesCategory" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 532px;" width="1064" height="500" class="chartjs-render-monitor"></canvas>
                    </div>
                    <!-- /.card-body -->
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <canvas id="pieChartBeneficiariesCategoryMale" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 532px;" width="1064" height="500" class="chartjs-render-monitor"></canvas>
                    </div>
                    <!-- /.card-body -->
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <canvas id="pieChartBeneficiariesHousehold" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 532px;" width="1064" height="500" class="chartjs-render-monitor"></canvas>
                    </div>
                    <!-- /.card-body -->
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <canvas id="pieChartBeneficiariesHouseholdMale" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 532px;" width="1064" height="500" class="chartjs-render-monitor"></canvas>
                    </div>
                    <!-- /.card-body -->
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <canvas id="pieChartBeneficiariesIncomeAndLivelihood" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 532px;" width="1064" height="500" class="chartjs-render-monitor"></canvas>
                    </div>
                    <!-- /.card-body -->
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <canvas id="pieChartBeneficiariesIncomeAndLivelihoodMale" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 532px;" width="1064" height="500" class="chartjs-render-monitor"></canvas>
                    </div>
                    <!-- /.card-body -->
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <canvas id="pieChartBeneficiariesWaterAndSanitation" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 532px;" width="1064" height="500" class="chartjs-render-monitor"></canvas>
                    </div>
                    <!-- /.card-body -->
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <canvas id="pieChartBeneficiariesWaterAndSanitationMale" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 532px;" width="1064" height="500" class="chartjs-render-monitor"></canvas>
                    </div>
                    <!-- /.card-body -->
                  </div>
                </div>
